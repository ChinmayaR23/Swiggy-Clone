...
const RestaurantCard = ({data}) => {
  ...
  return (
    ...
    <Link to={`/home/restaurants/${id}`} className='max-w-xs w-full border-box inline-flex flex-col space-y-2 p-4 border border-transparent transition-colors hover:border-slate-300 hover:shadow-md'>
